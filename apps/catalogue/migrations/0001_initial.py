# Generated by Django 2.2.9 on 2020-01-22 20:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requesteditems', related_query_name='requested_item', to='catalogue.Product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qty', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1)], verbose_name='Stock Issued')),
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='Date Created')),
                ('summary', models.TextField(blank=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issueditems', related_query_name='issued_item', to='catalogue.Product')),
